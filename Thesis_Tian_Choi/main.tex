...
% http://www.memphis.edu/gradschool/tdinfo_electronic.php#samplepages (referred as RQ(Requirements) in the text)
% Sample recent submitted Thesis can be found from:
...
%%-------------------------------------------------
% \includeonly files that have been made changes
%  for faster processing during revision processes
%%-------------------------------------------------
...
\include{List_of_Figures} % for 5 or more
