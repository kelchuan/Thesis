...
Location of a fault termination varies along the ridge as faulting behaviors change according to the variation in M values, as shown by black dashed lines in Figure~\hyperref[fig_Results1_1]{\ref{fig_Results1_1}} and black arrows in Figure~\hyperref[fig_Results1_2]{\ref{fig_Results1_2}}).
