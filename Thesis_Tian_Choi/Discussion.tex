...
\begin{figure}[h]
  ...
  \caption{Comparing bathymetry at 16 $\degree$N Mid-Atlantic Ridge to the corrugations of M58SinT1 at 550 kyr. \note[EC]{No scale of bathymetry given.}}
 \label{fig_Discussion_Observation_Corrugations16N_M58SinT1}
\end{figure}

\change[EC]{Observed c}{C}orrugations are also produced in the models. For instance, the spreading-parallel corrugations with wavelength of several kilometers \change[EC]{that appear on the surface of the OCC at 16 $\degree$N Mid-Atlantic Ridge are re}{are} produced \change[EC]{by}{in the}\note[EC]{I suggest this change because the similar wavelengths are just coincidence. In other words, if your model had much coarser or finer a resolution, the wavelength wouldn't be several kilometers.} model M58SinT1 (Figure~\hyperref[fig_Discussion_Observation_Corrugations16N_M58SinT1]{\ref{fig_Discussion_Observation_Corrugations16N_M58SinT1}}).
...
As decribed in the ``Results'' section, the corrugations are formed due to the \annote[EC]{moving off axis tensile failure}{Too many unorganized words. Awkward.} which results from asynchronous faulting along the ridge. This mechanism is further verified by simpler 3D models.
