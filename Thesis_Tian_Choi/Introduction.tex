...
% Listing these seemingly random facts doesn't look very helpful.
%
%About 70\% of the Earth's surface is convered by the oceanic crust. 
%Incessant seafloor spreading and associated magma upwelling at the mid-ocean ridges (MORs) produce new oceanic crust. 
%Seismic and volcanic activities are frequently occurring along the MORs due to  
%
%
