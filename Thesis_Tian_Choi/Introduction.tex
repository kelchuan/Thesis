...
Around 70\% of the Earth's crust is oceanic crust and \add[EC]{new oceanic crusts are forming at} the mid-ocean ridges (MORs), the longest mountain chains on the Earth, \remove[EC]{are where new crust are forming} with a multitude of seismic and volcanic activities. \remove[EC]{To study how new crust is created and how MORs evolve is significant for Earth Sciences.}  Geodynamic modeling \change[EC]{along with}{constrained by} a variety of geological, geophysical observation and lab experiment\add[EC]{s} \remove[EC]{constraints} have been used to study how the MORs work as a system under geological time scale.

\subsection{Research Questions}
\note[EC]{What's the purpose of this section? These three questions are what you are going to address in this thesis?}
...
According to \citep{Fowler2004}\note[EC]{Fowler's textbook is okay but try to find and cite the original works.}, variations in  mid-ocean ridge morphologies are mainly controlled by four factors: magma supply, tectonic strain, hydrothermal circulation and spreading rate. Among them, the spreading rate is the most important. Slow-to-intermediate spreading \change[EC]{centers}{ridges} (half spreading rate less than 4cm/year) produce median valleys that are typically 10$\sim$20km\note[EC]{Be consistent in the unit convention. For instance, decide whether to put one space between values and units or no space. Then, be consistent throughout the entire text.} wide and 1$\sim$2km deep (e.g., Mid-Atlantic Ridges, Figure 1(a)). Fast-spreading \change[EC]{centers}{ridges} (half spreading rate greater than 5cm/year) have axial highs that are 10$\sim$20 km wide, 0.3$\sim$0.5 km high (e.g., East Pacific Rise, Figure 1(b)).

\begin{figure}[H]
\centering
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{fig_Intro1_1.png}
  \caption{\small{Slow spreading Mid-Atlantic Ridge}}
  \label{fig_Intro1_1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{fig_Intro1_3.png}
...
\begin{figure}[H]
 \centering
  \includegraphics[scale=0.3]{fig_Intro3_1.png}
...
%\label{ch:related}
Magma supply at MORs is mostly a passive process when no hot plume \change[EC]{presents}{is present} \citep{Fowler2004}. Hot mantle rises up to fill the vacated room being created by plate separation and decompression \change[EC]{will lead}{leads}\note[EC]{for consistent tense} to partial melting of the hot mantle. The melt upwells due to both pressure difference and buoyancy from lateral density difference. When the melt solidifies near the surface, it forms new crust. This diking process can also release extensional stresses result\add[EC]{ing} from far-field \remove[EC]{driving} forces \add[EC]{driving plate motions}.
...
\begin{figure}[H]
 \centering
  \includegraphics[scale=0.7]{fig_Intro5_1.png}
